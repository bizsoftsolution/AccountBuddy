    ...
    public class SOPending : INotifyPropertyChanged
    {
        ...
        public static UserTypeDetail UserPermission
        {
            get
            {
                ...
                {
                    _UserPermission = UserAccount.User.UserType == null ? new UserTypeDetail() : UserAccount.User.UserType.UserTypeDetails.Where(x => x.UserTypeFormDetail.FormName == Forms.frmSOPending.ToString()).FirstOrDefault();
                }
        ...
        {
            return FMCGHubClient.HubCaller.Invoke<List<SOPending>>("SOPending_List", dtFrom, dtTo).Result;
        }
