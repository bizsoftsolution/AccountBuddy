...
namespace AccountBuddy.BLL
{
    public class CompanyDetail : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<CompanyFile> _CFiles;
        ...
        public static UserTypeDetail UserPermission
        {
            get
            {
                ...
                {
                    _UserPermission = UserAccount.User.UserType == null ? new UserTypeDetail() : UserAccount.User.UserType.UserTypeDetails.Where(x => x.UserTypeFormDetail.FormName == Forms.frmCompanySetting.ToString()).FirstOrDefault();
                }
        ...
        public CompanyFile companyFile
        {
            ...
            set
            {
                if (_companyFile != value)
                {
                    _companyFile = value;
                    NotifyPropertyChanged(nameof(companyFile));
                }
            }
        }
        public ObservableCollection<CompanyFile> CFiles
        {
            get
            {
                if (_CFiles == null) _CFiles = new ObservableCollection<CompanyFile>();
                return _CFiles;
            }
            set
            {
                ...
                {
                    _CFiles = value;
                    NotifyPropertyChanged(nameof(CFiles));
                }
            }
        }
        ...
        public void RemoveFiles(string ACode)
        {
            CompanyFile c = CFiles.Where(x => x.AttchmentCode == ACode).FirstOrDefault();
            CFiles.Remove(c);
        }
