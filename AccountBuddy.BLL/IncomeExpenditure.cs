...
namespace AccountBuddy.BLL
{
    public class IncomeExpenditure : INotifyPropertyChanged
    {
        ...
        private decimal _OpAmount;
        private decimal? _OPAmt;
        #endregion
        ...
        public decimal? OPAmt {
            ...
            set
            {
                ...
                {
                    _OPAmt = value;
                    NotifyPropertyChanged(nameof(OPAmt));
                }
            }
        }
        #endregion
        ...
        {
            return FMCGHubClient.HubCaller.Invoke<List<IncomeExpenditure>>("IncomeExpenditure_List", dtFrom, dtTo).Result;
        }
