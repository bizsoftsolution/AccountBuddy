...
namespace AccountBuddy.SL.Hubs
{
    public partial class ABServerHub
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (var b_SOd in SO.JRDetails)
                    {
                        ...
                        //}
                        b_SOd.ToMap<DAL.JobOrderReceivedDetail>(d_SOd);
                    }
        ...
        public BLL.JobOrderReceived JobOrderReceived_Find(string SearchText)
        {
            ...
            try
            {
                ...
                if (d != null)
                {
                    ...
                    d.ToMap<BLL.JobOrderReceived>(SO);
                    ...
                    foreach (var d_pod in d.JobOrderReceivedDetails)
                    {
                        ...
                        d_pod.ToMap<BLL.JobOrderReceivedDetail>(b_pod);
        ...
        {
            BLL.JobOrderReceived SO = d.ToMap<BLL.JobOrderReceived>(new BLL.JobOrderReceived());
            foreach (var d_SOd in d.JobOrderReceivedDetails)
            {
                SO.JRDetails.Add(d_SOd.ToMap<BLL.JobOrderReceivedDetail>(new BLL.JobOrderReceivedDetail()));
            }
        ...
        public BLL.JobOrderReceived JobOrderReceived_FindById(int ID)
        {
            ...
            try
            {
                ...
                if (d != null)
                {
                    ...
                    d.ToMap<BLL.JobOrderReceived>(P);
