...
namespace AccountBuddy.SL.Hubs
{
    public partial class ABServerHub
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (var b_Pd in P.PRDetails)
                    {
                       ...
                       // }
                        b_Pd.ToMap<DAL.PurchaseReturnDetail>(d_Pd);
                    }
                    DB.SaveChanges();
            ...
            try
            {
                ...
                if (d != null)
                {
                        ...
                        foreach (var d_pod in d.PurchaseReturnDetails)
                    {
                        ...
                        d_pod.ToMap<BLL.PurchaseReturnDetail>(b_pod);
        ...
        {
            BLL.PurchaseReturn PR = d.ToMap<BLL.PurchaseReturn>(new BLL.PurchaseReturn());
            foreach (var d_PRd in d.PurchaseReturnDetails)
            {
                PR.PRDetails.Add(d_PRd.ToMap<BLL.PurchaseReturnDetail>(new BLL.PurchaseReturnDetail()));
            }
            return PR;
        }
