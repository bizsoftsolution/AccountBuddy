...
namespace AccountBuddy.SL.Hubs
{
    public partial class ABServerHub
    {
        ...
        public List<BLL.IncomeExpenditure> IncomeExpenditure_List(DateTime dtFrom, DateTime dtTo)
        {
            ...
            decimal GTotalDr = 0, GTotalCr = 0, GTotalDrOP = 0, GTotalCrOP = 0, GTotalAmt = 0, GToatalAmtOP = 0;
            foreach (var ag in l1)
            {
                decimal TotalDr = 0, TotalCr = 0, TotalDrOP = 0, TotalCrOP = 0, TotalAmt = 0, TotalAmtOP = 0;
                lstIncomeExpenditure.AddRange(IncomeExpenditureByGroupName(ag, dtFrom, dtTo, "", ref TotalDr, ref TotalCr, ref TotalAmt, ref TotalDrOP, ref TotalCrOP, ref TotalAmtOP));
                GTotalDr += TotalDr;
                GTotalCr += TotalCr;
                GTotalDrOP += TotalDrOP;
                GTotalCrOP += TotalCrOP;
                GTotalAmt += TotalAmt;
                GToatalAmtOP += TotalAmtOP;
            }
        ...
        List<BLL.IncomeExpenditure> IncomeExpenditureByGroupName(DAL.AccountGroup ag, DateTime dtFrom, DateTime dtTo, string Prefix, ref decimal TotalDr, ref decimal TotalCr, ref decimal TotalAmt, ref decimal TotalDrOP, ref decimal TotalCrOP, ref decimal TotalOPAmt)
        {
            decimal GTotalDr = 0, GTotalCr = 0, GTotalDrOP = 0, GTotalCrOP = 0;
            decimal GTotalAmt = 0, GTotalAmtOP = 0;
            List<BLL.IncomeExpenditure> lstIncomeExpenditure = new List<BLL.IncomeExpenditure>();
            decimal total = 0;
            ...
            {
                lstIncomeExpenditure.AddRange(IncomeExpenditureByGroupName(uag, dtFrom, dtTo, Prefix + "     ", ref GTotalDr, ref GTotalCr, ref GTotalAmt, ref GTotalDrOP, ref GTotalCrOP, ref GTotalAmtOP));
            }
