...
namespace AccountBuddy.SL.Hubs
{
    public partial class ABServerHub
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (var b_SRd in P.SRDetails)
                    {
                        ...
                        //}
                        b_SRd.ToMap<DAL.SalesReturnDetail>(d_SRd);
                    }
            ...
            try
            {
                ...
                if (d != null)
                {
                    ...
                    foreach (var d_pod in d.SalesReturnDetails)
                    {
                        ...
                        d_pod.ToMap<BLL.SalesReturnDetail>(b_pod);
        ...
        {
            BLL.SalesReturn SR = d.ToMap<BLL.SalesReturn>(new BLL.SalesReturn());
            foreach (var d_SRd in d.SalesReturnDetails)
            {
                SR.SRDetails.Add(d_SRd.ToMap<BLL.SalesReturnDetail>(new BLL.SalesReturnDetail()));
            }
            return SR;
        }
