    ...
    public partial class ABServerHub
    {
        ...
        public bool StockIn_Save(BLL.StockIn P)
        {
            try
            {
                ...
                if (OtherClientsOnGroup.Count > 0) Clients.Clients(OtherClientsOnGroup).StockIn_RefNoRefresh(StockIn_NewRefNo());
        ...
        {
            BLL.StockIn P = AppLib.ToMap(d, new BLL.StockIn());
            foreach (var d_Pd in d.StockInDetails)
            {
                P.STInDetails.Add(AppLib.ToMap(d_Pd, new BLL.StockInDetail()));
            }
            return P;
        }
